...
### 8.1 已完成内容（2025-10-24~2025-10-26）
...
- **工程兼容性**：配置 `.xccurrentversion` 并将数据模型纳入 Xcode 工程，避免因资源缺失导致的 IDE 崩溃。
...
| 2025-10-26 | v0.2.1 工程兼容修复 | 为数据模型补充 `.xccurrentversion`，并将其写入 Xcode 工程配置，修复打开项目即崩溃的问题。 |
